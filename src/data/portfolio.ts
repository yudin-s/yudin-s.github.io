...
export const links = [
  { label: 'Live site', url: 'https://yudin-s.github.io/' },
  { label: 'GitHub', url: 'https://github.com/yudin-s' },
...
export const education = [
  {
    ...
    institution:
      'Donetsk Technical University. GPA 4.5; led the programming contest team and reached final stages of All-Ukrainian sport programming competitions.',
  },
  {
    period: '2009 - 2011',
    degree: 'Zaporizhskiy Technical Lyceum',
    institution: 'National-level technical high school with math, physics, and programming specialization.',
  },
];
...
export const skills = {
  ...
  backend: ['Node.js', 'NestJS', 'Express', 'Python', 'PHP', 'Java', 'REST', 'GraphQL', 'Laravel'],
  databases: ['MySQL', 'MariaDB', 'PostgreSQL', 'MongoDB', 'Redis', 'Oracle'],
  devops: [
    'AWS',
    'Docker',
    'Kubernetes',
...
export const openSource = [
  {
    ...
    pullRequest: '#16948',
    commitMessage: 'fix(core): settle skipped provider initialization',
    commitAuthor: 'yudin-s',
    commitDate: 'Merged May 14, 2026',
    pullRequestUrl: 'https://github.com/nestjs/nest/pull/16948',
  },
  {
    repository: 'nestjs/nest',
    pullRequest: '#16945',
    commitMessage: 'feat(microservices): add grpc exception filter',
    commitAuthor: 'yudin-s',
    commitDate: 'Merged May 13, 2026',
    pullRequestUrl: 'https://github.com/nestjs/nest/pull/16945',
  },
  {
    repository: 'nestjs/nest',
    pullRequest: '#16943',
    commitMessage: 'fix(microservices): support regex Kafka patterns',
    commitAuthor: 'yudin-s',
    commitDate: 'Merged May 13, 2026',
    pullRequestUrl: 'https://github.com/nestjs/nest/pull/16943',
  },
  {
    repository: 'tailwindlabs/tailwindcss',
    pullRequest: '#20052',
    commitMessage: 'Fix canonicalize crash with plugin component values (#20052)',
    commitAuthor: 'yudin-s + Robin Malfait',
    commitDate: 'Merged May 14, 2026',
    pullRequestUrl: 'https://github.com/tailwindlabs/tailwindcss/pull/20052',
  },
];
